...
INSERT INTO ABOUT(title,description) VALUES('CTHM Team','<b>Support Staff</b></h4>
                                            <ul>
                                                <li>
...
INSERT INTO ABOUT(title,description) VALUES('Awards and Recognition','The FAQ title can be adjusted in the settings tab of the App Settings. You can also remove the title by unchecking its checkbox To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.in the settings tab.');
INSERT INTO ABOUT(title,description) VALUES('Facilities','To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.');
INSERT INTO ABOUT(title,description) VALUES('Linkages','To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.To add a new question go to app settings and press "Manage Questions" button.');
INSERT INTO ABOUT(title,description,img_id) VALUES('Location Map and Contact Details','                                                <b>Office Address</b><br>
