...
public class AlumniProfileCRUD {
    public static ArrayList<AlumniProfile> listAlumniProfile(Connection con) throws SQLException {
        ...
        try (PreparedStatement stmt = con.prepareStatement("SELECT * FROM ALUMNI_PROFILE a JOIN IMAGE I ON I.img_id=a.img_id")) {
      ...
      public static AlumniProfile readStudentOrg(Connection con,int alumni_id) throws SQLException {
        try (PreparedStatement stmt = con.prepareStatement("SELECT * FROM ALUMNI_PROFILE a JOIN IMAGE I ON I.img_id=a.img_id WHERE alumni_id=? ;")) {
