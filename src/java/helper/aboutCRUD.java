...
public class aboutCRUD {
    ...
    public static int editAboutImage(Connection con,int aboutId,int img_id) throws SQLException {
        try (PreparedStatement stmt = con.prepareStatement("UPDATE ABOUT SET img_id=? WHERE post_id=?")) {
