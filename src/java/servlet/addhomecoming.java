 ...
 */
public class addhomecoming extends HttpServlet {
   ...
   isMultipart = ServletFileUpload.isMultipartContent(request);
      ...
      try { 
         ...
         AlumniHomecoming homecoming=new AlumniHomecoming(caption,image);
         AlumniCRUD.createAlumniHomecoming(JDBC.getCon(), homecoming);
