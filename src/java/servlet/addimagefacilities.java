 ...
 */
public class addimagefacilities extends HttpServlet {
 ...
 isMultipart = ServletFileUpload.isMultipartContent(request);
      ...
      try { 
         ...
         while ( i.hasNext () ) {
            ...
            if(fi.isFormField()){
                 if(fi.getFieldName().equals("majorid")){
                     majorID=Integer.parseInt(fi.getString());
                 }
                 else if(fi.getFieldName().equals("courseid")){
                     courseID=Integer.parseInt(fi.getString());
                 }
             }
         ...
         FacilityImage Image=new FacilityImage(majorID,image);
         FacilityImageCRUD.createFacilityImage(JDBC.getCon(), Image);
