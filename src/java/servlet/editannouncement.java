...
public class editannouncement extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Announcements announcement=AnnouncementCRUD.readAnnouncements(JDBC.getCon(), Integer.parseInt(id));
            response.getWriter().print(announcement.getJSON().toString());
        } catch (SQLException ex) {
            Logger.getLogger(editannouncement.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
