                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${student.orgAbout}</td>
                                    <td>${student.orgObjectives}</td>
                                    <td>${student.orgOffices}</td>
                                    <td>${student.orgPhone}</td>
                                    <td>${student.orgActivities}</td>
                                    <td>${student.image.description}</td>
                                    <td><button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#editOrgModal">Edit</button></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Objectives"></textarea>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Offices"></textarea>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Phone"></textarea>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Activities"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Image</label>
