<%-- 
    Document   : hospitalityLead
    Created on : Aug 12, 2018, 1:22:23 AM
...
<html>
    <head>
        <title>UST-CTHM | Hospitality Leadership</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div>
            ...
            <div class="content-wrap">
                <div class="inner-content">
                    <h2 class="merriweather">Major in Hospitality Leadership</h2><hr><br>
                    <div class="row lato">
                        <div class="col-4">
