...
<%@page import="bean.StudentServices"%>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div>
                <a class="header-link" href="index.html">
                    <div class="row header-content">
                        ...
                        <div class="col-sm-8 header-text blue-text">
                    ...
                    <div class="row lato">
                        <div class="col-4">
                            <div class="list-group" id="list-tab" role="tablist">
                                    <c:forEach items="${studentservices}" varStatus="loop" var="studentservice" >
                                        <c:choose>
                                        <c:when test="${loop.first}">
                                            <a class="list-group-item list-group-item-action active" id="list-${studentservice.title}-list" data-toggle="list" href="#list-${studentservice.title}" role="tab" aria-controls="${studentservice.title}">${studentservice.icon}${studentservice.title}</a>
                                        </c:when>
                                        <c:otherwise>
                                             <a class="list-group-item list-group-item-action" id="list-${studentservice.title}-list" data-toggle="list" href="#list-${studentservice.title}" role="tab" aria-controls="${studentservice.title}">${studentservice.icon}${studentservice.title}</a>
                                        </c:otherwise>
                                        </c:choose>
                                    </c:forEach>
                            </div>
                        ...
                        <div class="col-8">
                            <div class="tab-content" id="nav-tabContent">
                             <c:forEach items="${studentservices}" varStatus="loop" var="studentservice" >
                                    <c:choose>
                                        <c:when test="${loop.first}">
                                            <div class="tab-pane fade show active" id="list-${studentservice.title}" role="tabpanel" aria-labelledby="list-${studentservice.title}-list">
                                                <h2 class="lato alumni-heading"><b>${studentservice.title}</b></h2>
                                                <p class="lato">
                                        ...
                                        <c:otherwise>
                                            <div class="tab-pane fade" id="list-${studentservice.title}" role="tabpanel" aria-labelledby="list-${studentservice.title}-list">
                                                <h2 class="lato alumni-heading"><b>${studentservice.title}</b></h2>
                                                <p class="lato">
                                                    ${studentservice.description}
                                                </p>
